...
urlpatterns = [
    url(r'^calendar/(?P<resource_type>\w+)/$', leases_views.CalendarView.as_view(), name='calendar'),
    url(r'^calendar/(?P<resource_type>\w+)/resources.json$', leases_views.calendar_data_view,
        name='calendar_data'),
